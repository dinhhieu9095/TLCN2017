			...
			<div class="container">
				<div class="row clearfix pv-50">
					<s:form commandName="customerData"
						action="${pageContext.request.contextPath }/Updatecustomer?customerID=${customer1.customerID}"
						method="post">

						<div class="col-xs-12 col-sm-8 col-md-8 xs-mb">
							<div class="white-bg payment-wrapper">
								<h3 class="section-title">
									Khách hàng <span class="step active">1</span>
								</h3>
								...
								<div class="col-xs-12 col-sm-6 col-md-6">
									...
									<div class="form-group">
										<c:if test="${customer1.gender=='Nam' }">
