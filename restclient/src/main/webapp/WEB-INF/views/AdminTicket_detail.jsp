        ...
        <div class="">
          <div class="page-title">
            <div class="title_left">
              <h3>Hóa đơn khách hàng <small>Listing design</small></h3>
            </div>
            ...
            <div class="col-md-12">
              <div class="x_panel">
                ...
                <div class="x_content">
                  ...
                  <p>Danh sách hóa đon của khách hàng</p>
                  ...
                  <table class="table table-striped projects">
                    ...
                    <tbody>
                    <c:forEach var="ticket_details" items="${ticket_details}">
                      <tr>
                        ...
                        <td>
                        <c:if test="${ticket_details.confirm==true}">
                          <a>Đã xác nhận</a>
                        </c:if>
                        <c:if test="${ticket_details.confirm==false}">
                          <a>Chưa xác nhận</a>
                        </c:if>
                        </td>
                        <td>
                        <c:if test="${customer.customerID==1}">
                          <a type="button" href="${pageContext.request.contextPath}/Confirm?ticket_detailID=${ticket_details.ticket_detailID}" class="btn btn-success btn-xs">Xác nhận</a>
                       </c:if>
                        </td>
                        <td>
                          <a href="#" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> Sửa </a>
                          <a href="${pageContext.request.contextPath}/DeleteTicket_detail?ticket_detailID=${ticket_details.ticket_detailID}" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> Xóa </a>
                        </td>
                      </tr>
                     </c:forEach>
                    </tbody>
