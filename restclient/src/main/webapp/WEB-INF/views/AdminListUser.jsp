                  ...
                  <table class="table table-striped projects">
                    ...
                    <c:forEach var="customers" items="${customers}">
                      <tr>
                        ...
                        <td>
                          <a>${customers.lastName} ${customers.firstName }</a>
                        </td>
                        <td>
                          <a>${customers.phone}</a>
                        </td>
                        ...
                        <td>
                          <a>${customers.gender}</a>
                        </td>
                 
                        <td>
                          <a href="${pageContext.request.contextPath}/updatecustomer?customerID=${customers.customerID}" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> Edit </a>
                          <a href="${pageContext.request.contextPath}/Deletecustomer?customerID=${customers.customerID}" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> Delete </a>
                        </td>
                      </tr>
                     </c:forEach>
                    </tbody>
