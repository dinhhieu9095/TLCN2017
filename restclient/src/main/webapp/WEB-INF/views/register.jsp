	...
	<div id="body_wrapper" class="full">
		...
		<div id="page_title">
			<div class="container clearfix">
				<div class="page-name">Đăng ký</div>
				<div class="breadcrumb clearfix">
					<a href="${pageContext.request.contextPath }/Index">Home</a> <span class="current-page">Đăng ký</span>
				</div>
			</div>
		</div>
		<!-- end slider_wrapper -->
					...
					<div class="col-xs-12 col-sm-8 col-md-8 xs-mb">
						<div class="white-bg payment-wrapper">
							<h3 class="section-title">
								Đăng ký <span class="step active">1</span>
							</h3>
							...
							<p style="color: red;">${failed}</p>
									...
									<div class="form-group">
											<div class="styled-radio inline">
												<label for="visa"> <input type="radio" name="gender"
													value="Nam" checked> <img src="" alt="Nam">
												</label>
											</div>
								...
								<button type="submit" value="Register" class="btn btn-primary">Đăng ký</button>
